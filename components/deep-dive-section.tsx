...
export default function DeepDiveSection() {
  ...
  return (
    <div className="space-y-8">
      {/* Custom Tab Navigation - Improved Responsive Design */}
      <div className="border-b border-gray-200">
        <nav className="flex overflow-x-auto scrollbar-hide" aria-label="Deep Dive Navigation">
          {components.map((component, index) => {
            ...
            return (
              <button
                ...
                className={`
                  relative flex-shrink-0 px-3 sm:px-6 py-4 text-sm font-medium border-b-2 transition-all duration-200
                  ${
                    isActive
              ...
              >
                <div className="flex flex-col items-center justify-center gap-2 min-w-0">
                  ...
                  <div className="text-center">
                    {/* Mobile: Short titles */}
                    <span className="block sm:hidden text-xs leading-tight">{component.shortTitle}</span>
                    {/* Tablet: Medium titles */}
                    <span className="hidden sm:block lg:hidden text-sm leading-tight">{component.mediumTitle}</span>
                    {/* Desktop: Full titles */}
                    <span className="hidden lg:block text-sm leading-tight max-w-[200px]">{component.title}</span>
                  </div>
